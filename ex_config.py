...
from DangerCat_config.config import Config
...
class Development(Config):
    ...
    BOT_LIBRARY = "telethon"  # fill 'pyrogram' if you want pyrogram version of DangerBot else leave it as it is.

    DB_URI = "Your value"  # A postgresql database url from elephantsql

    DANGERCAT_SESSION = "Your value"  # telethon or pyrogram string according to BOT_LIBRARY
