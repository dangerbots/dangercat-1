...
@danger_cat_cmd(pattern="spam(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="dspam(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="uspam(?:\s|$)([\s\S]*)")
...
# Team HellBot
@danger_cat_cmd(pattern="bspam(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="mspam(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="endspam$")
