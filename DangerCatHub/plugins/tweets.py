...
@danger_cat_cmd(pattern="mytweet(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="trump(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="modi(?:\s|$)([\s\S]*)")
async def nekobot(event):
    lists = event.text.split(" ", 1)
    reply = await event.get_reply_message()
    text = None
...
@danger_cat_cmd(pattern="mia(?:\s|$)([\s\S]*)")
async def nekobot(event):
    lists = event.text.split(" ", 1)
    reply = await event.get_reply_message()
    text = None
...
@danger_cat_cmd(pattern="dani(?:\s|$)([\s\S]*)")
async def nekobot(event):
    lists = event.text.split(" ", 1)
    reply = await event.get_reply_message()
    text = None
...
@danger_cat_cmd(pattern="pappu(?:\s|$)([\s\S]*)")
async def nekobot(event):
    lists = event.text.split(" ", 1)
    reply = await event.get_reply_message()
    text = None
...
@danger_cat_cmd(pattern="sunny(?:\s|$)([\s\S]*)")
async def nekobot(event):
    lists = event.text.split(" ", 1)
    reply = await event.get_reply_message()
    text = None
...
@danger_cat_cmd(pattern="johhny(?:\s|$)([\s\S]*)")
async def nekobot(event):
    lists = event.text.split(" ", 1)
    reply = await event.get_reply_message()
    text = None
...
@danger_cat_cmd(pattern="gandhi(?:\s|$)([\s\S]*)")
async def nekobot(event):
    lists = event.text.split(" ", 1)
    reply = await event.get_reply_message()
    text = None
...
@danger_cat_cmd(pattern="tweet(?:\s|$)([\s\S]*)")
async def nekobot(event):
    lists = event.text.split(" ", 1)
    reply = await event.get_reply_message()
    text = None
...
@danger_cat_cmd(pattern="cmm(?:\s|$)([\s\S]*)")
async def nekobot(event):
    lists = event.text.split(" ", 1)
    reply = await event.get_reply_message()
    text = None
...
@danger_cat_cmd(pattern="kanna(?:\s|$)([\s\S]*)")
async def nekobot(event):
    lists = event.text.split(" ", 1)
    reply = await event.get_reply_message()
    text = None
