...
@danger_cat_cmd(pattern="song(?:\s|$)([\s\S]*)")
async def songs(event):
    ...
    try:
        ...
        thumb_name = f'thumb{DANGERCATUSERID}.jpg'
...
@danger_cat_cmd(pattern="vsong(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="lyrics(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="wsong(?:\s|$)([\s\S]*)")
async def _(event):
...
@danger_cat_cmd(pattern="spotify(?:\s|$)([\s\S]*)")
async def _(event):
