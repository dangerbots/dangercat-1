...
@danger_cat_cmd(pattern="ytube(?:\s|$)([\s\S]*)")
async def _(event):
...
@danger_cat_cmd(pattern="ddg(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
    sample_url = (
...
@danger_cat_cmd(pattern="altn(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
...
@danger_cat_cmd(pattern="lmkp(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
...
@danger_cat_cmd(pattern="gem(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
...
@danger_cat_cmd(pattern="rchiv(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
