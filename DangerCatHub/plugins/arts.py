...
@danger_cat_cmd(pattern="carry(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="sthink(?:\s|$)([\s\S]*)")
async def kraken(event):
    _, _, dangerbot_mention = await client_id(event)
    name = event.pattern_match.group(1)
    B = (
...
@danger_cat_cmd(pattern="sfrog(?:\s|$)([\s\S]*)")
async def kraken(event):
    _, _, dangerbot_mention = await client_id(event)
    name = event.pattern_match.group(1)
    C = (
...
@danger_cat_cmd(pattern="sdead(?:\s|$)([\s\S]*)")
async def kraken(event):
    _, _, dangerbot_mention = await client_id(event)
    name = event.pattern_match.group(1)
    D = (
...
@danger_cat_cmd(pattern="strump(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="schina(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="monster$")
async def _(monster):
    await eor(monster, G)


@danger_cat_cmd(pattern="pig$")
async def _(pig):
    await eor(pig, H)


@danger_cat_cmd(pattern="gun$")
async def _(gun):
    await eor(gun, I)


@danger_cat_cmd(pattern="dog$")
async def _(dog):
    await eor(dog, J)


@danger_cat_cmd(pattern="hello$")
async def _(hello):
    await eor(hello, K)


@danger_cat_cmd(pattern="hmf$")
async def _(hmf):
    await eor(hmf, L)


@danger_cat_cmd(pattern="couple$")
async def _(couple):
    await eor(couple, M)


@danger_cat_cmd(pattern="sup$")
async def _(supreme):
    await eor(supreme, N)


@danger_cat_cmd(pattern="india$")
async def _(event):
    await eor(event, O)


@danger_cat_cmd(pattern="wc$")
async def _(welcome):
    await eor(welcome, P)


@danger_cat_cmd(pattern="snk$")
async def _(snake):
    await eor(snake, Q)


@danger_cat_cmd(pattern="bye$")
async def _(bye):
    await eor(bye, R)


@danger_cat_cmd(pattern="shitos$")
async def _(shitos):
    await eor(shitos, S)


@danger_cat_cmd(pattern="dislike$")
async def _(dislike):
    await eor(dislike, T)
