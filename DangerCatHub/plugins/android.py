...
@danger_cat_cmd(pattern="app(?:\s|$)([\s\S]*)")
async def apk(event):
...
@danger_cat_cmd(pattern="device(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="codename(?: |)([\S]*)(?: |)([\s\S]*)")
...
@danger_cat_cmd(pattern="specs(?: |)([\S]*)(?: |)([\s\S]*)")
...
@danger_cat_cmd(pattern="twrp(?:\s|$)([\s\S]*)")
