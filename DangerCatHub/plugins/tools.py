...
@danger_cat_cmd(pattern="time(?:\s|$)([\s\S]*)")
async def _(event):
...
@danger_cat_cmd(pattern="barcode(?:\s|$)([\s\S]*)")
async def _(event):
    dangercat_event = await eor(event, "...")
    start = datetime.datetime.now()
    input_str = event.pattern_match.group(1)
    ...
    try:
        ...
        await dangercat_event.edit(str(e))
        return
    end = datetime.datetime.now()
    ms = (end - start).seconds
    await dangercat_event.edit("Created BarCode in {} seconds🤓".format(ms))
    await asyncio.sleep(5)
    await dangercat_event.delete()


@danger_cat_cmd(pattern="makeqr(?: |$)([\s\S]*)")
...
@danger_cat_cmd(pattern="calendar(?:\s|$)([\s\S]*)")
async def _(event):
...
@danger_cat_cmd(pattern="currency(?:\s|$)([\s\S]*)")
async def _(event):
...
@danger_cat_cmd(pattern="currencies$")
...
@danger_cat_cmd(pattern="ifsc(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
...
@danger_cat_cmd(pattern="color(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
    message_id = None
...
@danger_cat_cmd(pattern="xkcd(?:\s|$)([\s\S]*)")
async def _(event):
...
@danger_cat_cmd(pattern="dns(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
...
@danger_cat_cmd(pattern="url(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
...
@danger_cat_cmd(pattern="unshort(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
