...
@danger_cat_cmd(pattern="fext ([\s\S]*)")
async def _(event):
...
@danger_cat_cmd(pattern="pips(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="suicide$")
async def _(event):
