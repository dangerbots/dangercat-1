...
@danger_cat_cmd(pattern="type(?:\s|$)([\s\S]*)")
async def _(event):
...
@danger_cat_cmd(pattern="emoji(?:\s|$)([\s\S]*)")
async def _(event):
...
@danger_cat_cmd(pattern=f"gendar$")
async def metoo(e):
    txt = random.choice(GENDER)
    await eor(e, txt)


@danger_cat_cmd(pattern=f"shrug$")
async def metoo(e):
    txt = random.choice(SHRUG)
    await eor(e, txt)


@danger_cat_cmd(pattern=f"dogge")
async def metoo(e):
    txt = random.choice(DOG)
    await eor(e, txt)


@danger_cat_cmd(pattern=f"mesed$")
async def metoo(e):
    txt = random.choice(SED)
    await eor(e, txt)


@danger_cat_cmd(pattern=f"medead$")
async def metoo(e):
    txt = random.choice(DEAD)
    await eor(e, txt)


@danger_cat_cmd(pattern=f"confused$")
async def metoo(e):
    txt = random.choice(CONFUSED)
    await eor(e, txt)


@danger_cat_cmd(pattern=f"lobb$")
async def metoo(e):
    txt = random.choice(LOB)
    await eor(e, txt)


@danger_cat_cmd(pattern=f"wut$")
async def metoo(e):
    txt = random.choice(WTF)
    await eor(e, txt)


@danger_cat_cmd(pattern=f"wavee$")
async def metoo(e):
    txt = random.choice(WAVING)
    await eor(e, txt)


@danger_cat_cmd(pattern=f"hehe$")
async def metoo(e):
    txt = random.choice(EMOTICONS)
    await eor(e, txt)


@danger_cat_cmd(pattern="figlet(?:\s|$)([\s\S]*)")
