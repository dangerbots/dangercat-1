...
@danger_cat_cmd(pattern="ccry$")
async def cry(e):
    await eor(e, "(;´༎ຶД༎ຶ)")


@danger_cat_cmd(pattern="fap$")
async def _(event):
...
@danger_cat_cmd(pattern="nothappy$")
async def _(event):
...
@danger_cat_cmd(pattern="lovestory$")
async def _(event):
