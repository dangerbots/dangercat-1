...
@danger_cat_cmd(pattern="kickall$", allow_sudo=False)
async def _(event):
    DANGERCATUSERID, _, _ = await client_id(event)
    result = await event.client(
        functions.channels.GetParticipantRequest(event.chat_id, DANGERCATUSERID)
    )
...
@danger_cat_cmd(pattern="banall$", allow_sudo=False)
async def _(event):
    DANGERCATUSERID, _, _ = await client_id(event)
    result = await event.client(
        functions.channels.GetParticipantRequest(event.chat_id, DANGERCATUSERID)
...
@danger_cat_cmd(pattern="unbanall$")
async def _(event):
    if event.is_private:
        return
...
@danger_cat_cmd(pattern="ikuck(?:\s|$)([\s\S]*)")
async def _(event):
    if event.is_private:
        return
...
@danger_cat_cmd(pattern="blockall(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="blockc(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="blocknc(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern ="unblockall(?:\s|$)([\s\S]*)")
