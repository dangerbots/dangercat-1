...
@danger_cat_cmd(pattern="info(?:\s|$)([\s\S]*)")
async def _(event):
...
@danger_cat_cmd(pattern="chatinfo(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="users(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="admins(?:\s|$)([\s\S]*)")
async def _(event):
...
@danger_cat_cmd(pattern="bots(?:\s|$)([\s\S]*)")
async def _(event):
