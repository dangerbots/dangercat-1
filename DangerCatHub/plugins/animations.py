...
async def _(event):
    ...
    animation_chars = [
        ...
        f"**Build started by user** {dangerbot_mention}",
        f"**Deploy** `535a74f0` **by user** **{dangerbot_mention}**",
...
@danger_cat_cmd(pattern="fleaveme$")
async def _(event):
...
@danger_cat_cmd(pattern=f"wahack$")
async def _(event):
    animation_interval = 0.3
...
@danger_cat_cmd(pattern="solarsystem$")
async def _(event):
...
@danger_cat_cmd(pattern="hnd ([\s\S]*)")
async def _(event):
...
@danger_cat_cmd(pattern="getwell$")
async def getwell(event):
    await eor(event, "🌹🌹🌹🌹🌹🌹🌹🌹 \n🌹😷😢😓😷😢💨🌹\n🌹💝💉🍵💊💐💝🌹\n🌹 GetBetter Soon! 🌹\n🌹🌹🌹🌹🌹🌹🌹🌹")


@danger_cat_cmd(pattern="switch$")
async def _(event):
    animation_interval = 0.5
    animation_ttl = range(0, 11)
...
@danger_cat_cmd(pattern="sprinkle$")
...
@danger_cat_cmd(pattern="kiler(?:\s|$)([\s\S]*)")
async def _(event):
    name = event.pattern_match.group(1)
    xyz = await client_id(event)
    dangerbot_mention = xyz[2]
    if not name:
        name = "die"
    animation_interval = 0.7
    animation_ttl = range(8)
    event = await eor(event, f"**Ready Commando **__{dangerbot_mention}....")
    animation_chars = [
        "Ｆｉｉｉｉｉｒｅ",
        f"__**Commando **__{dangerbot_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - \n _/﹋\_\n",
        f"__**Commando **__{dangerbot_mention}          \n\n_/﹋\_\n (҂`_´)\n  <,︻╦╤─ ҉ - -\n _/﹋\_\n",
        f"__**Commando **__{dangerbot_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - - -\n _/﹋\_\n",
        f"__**Commando **__{dangerbot_mention}          \n\n_/﹋\_\n (҂`_´)\n<,︻╦╤─ ҉ - -\n _/﹋\_\n",
        f"__**Commando **__{dangerbot_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - \n _/﹋\_\n",
...
@danger_cat_cmd(pattern="thinking$")
async def _(event):
...
@danger_cat_cmd(pattern="padmin ([\s\S]*)")
async def _(event):
    animation_interval = 1
...
async def _(event):
    ...
    animation_chars = [
        ...
        f"`Target Selected By Hacker:` {dangerbot_mention}",
        ...
        "`Hacking... 100%\n█████████HACKED███████████ `\n\n\n  TERMINAL:\nDownloading Bruteforce-Telegram-0.1.tar.gz (9.3 kB)\nCollecting Data Package\n  Downloading Telegram-Data-Sniffer-7.1.1-py2.py3-none-any.whl (82 kB)\nBuilding wheel for Tg-Bruteforcing (setup.py): finished with status 'done'\nCreated wheel for telegram: filename=Telegram-Data-Sniffer-0.0.1-py3-none-any.whl size=1306 sha256=cb224caad7fe01a6649188c62303cd4697c1869fa12d280570bb6ac6a88e6b7e\n  Stored in directory: /app/.cache/pip/wheels/a2/9f/b5/650dd4d533f0a17ca30cc11120b176643d27e0e1f5c9876b5b\n\n **Successfully Hacked Telegram Server Database**\n\n\n🔹Output: Generating.....",
        f"`Targeted Account Hacked...\n\nPay 999$ To` {dangerbot_mention} `To Remove This Hack`\n\n\n  TERMINAL:\nDownloading Bruteforce-Telegram-0.1.tar.gz (9.3 kB)\nCollecting Data Package\n  Downloading Telegram-Data-Sniffer-7.1.1-py2.py3-none-any.whl (82 kB)\nBuilding wheel for Tg-Bruteforcing (setup.py): finished with status 'done'\nCreated wheel for telegram: filename=Telegram-Data-Sniffer-0.0.1-py3-none-any.whl size=1306 sha256=cb224caad7fe01a6649188c62303cd4697c1869fa12d280570bb6ac6a88e6b7e\n  Stored in directory: /app/.cache/pip/wheels/a2/9f/b5/650dd4d533f0a17ca30cc11120b176643d27e0e1f5c9876b5b\n\n **Successfully Hacked Telegram Server Database**\n\n\n🔹**Output:** Successful",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await event.edit(animation_chars[i % 12])
