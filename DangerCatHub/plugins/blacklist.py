...
from DangerCatHub.DB import blacklist_sql as sq
...
@danger_cat_cmd(pattern="addblacklist(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="rmblacklist(?:\s|$)([\s\S]*)")
...
@danger_cat_cmd(pattern="listblacklist$")
