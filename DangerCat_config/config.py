...
class Config(object):
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "danger_bots")
    MY_GROUP = os.environ.get("YOUR_GROUP", "dangerbots")
    ...
    DANGERCAT_SESSION = os.environ.get("DANGERCAT_SESSION", None)
    ...
    TELEGRAPH_NAME = os.environ.get("TELEGRAPH_NAME", "[ @DANGER_BOTS ]")
    TEMP_DIR = os.environ.get("TEMP_DIR", None)
    TMP_DOWNLOAD_DIRECTORY = os.environ.get("TMP_DOWNLOAD_DIRECTORY", "./DOWNLOADS/")
    THUMB_IMG = os.environ.get("THUMB_IMG", "./DangerCat_config/resources/pics/hellbot_logo.jpg")
    UNLOAD = list(os.environ.get("UNLOAD", "").split())
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/Dangerprobots/dangercat")
